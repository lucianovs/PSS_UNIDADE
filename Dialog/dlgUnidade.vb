    ...
    Private Sub btnPesquisa_Click(sender As Object, e As EventArgs) Handles btnPesquisa.Click
        ...
        If Not Trim(txtPesquisa.Text) = "" Then
            cQuery = "Select EUN000.UN000_CODRED, EUN000.UN000_CLAUNI, EUN000.UN000_NOMUNI " & _
                "FROM EUN000 where EUN000.UN000_STAUNI<>'I' " 
            nStart = 1
            ...
            dtPesquisar.Clear()
        Else
            MsgBox("Digite um valor para pesquisar. Para melhor performance, digitar mais de uma informação.")
        End If
