Public Class classValidarCPF_CNPJ
    ...
    Public Property cpf() As String
        ...
        Set(ByVal Valor As String)
            ...
            If bValida Then
                sCPF = Valor
            Else
                sCPF = "000.000.000-00" 'Throw (New System.ArgumentException(msgErro, "Numero do CPF"))
            End If
        End Set
    End Property
    ...
    Public Property cnpj() As String
        ...
        Set(ByVal Valor As String)
            ...
            If bValida Then
                sCNPJ = Valor
            Else
                sCNPJ = "00.000.000/0000-00" 'Throw (New System.ArgumentException(Valor, "Numero do CNPJ"))
            End If
        End Set
    End Property
